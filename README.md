...
Al-Furkan Advanced Flutter Quran App (BLoC + Clean Architecture) is an open-source Quran companion built with Flutter for daily reading, study, remembrance, and personalization.
...
keywords:
flutter quran app
open source islamic app
quran app bloc flutter
...
## ✨ المزايا الحالية داخل التطبيق

تمت مراجعة الشاشات والموديولات الحالية داخل المشروع، وهذه أبرز القدرات الموجودة فعلاً الآن في "الفُرقان":

### 📖 القراءة والمصحف
* **مصحف QCF تفاعلي** بخطوط عثمانية وصفحات قريبة من المصحف الورقي مع دعم الوضعين الفاتح والداكن.
* **وضع القراءة آية بآية** مع تنقل سريع، شريط تحكم صوتي، وخيارات تفاعل لكل آية.
* **بحث قرآني سريع** في النص، مع الوصول المباشر للسورة والآية والصفحة.
* **فهرس وتنقل ذكي** بين السور والأجزاء والأحزاب والصفحات.

### 🧠 المكتبة التفاعلية للآية
* **منيو مكتبة مدمجة داخل المصحف** تعرض الآية الحالية بشكل واضح مع التنقل بين الآيات.
* **اختيار كلمة من الآية** لعرض معلوماتها فقط بدل حشو معلومات الآية كلها.
* **تبويبات كلمة بكلمة** تشمل: الترجمة، الإعراب، الصرف، والقراءات.
* **مشاركة محتوى الآية** كنص أو عبر صيغ مشاركة مرتبطة بالمكتبة.
* **استخراج وعرض التفاسير المختارة** مع تقليل التكرار بين الموارد المدمجة والمحملة.

### 📚 إدارة الموارد القرآنية
* **مكتبة موارد موحدة** للترجمات، التفاسير، كلمة بكلمة، ومعلومات الكلمات.
* **اختيار أكثر من ترجمة وأكثر من تفسير** في الوقت نفسه.
* **حذف مورد واحد أو حذف جماعي** للموارد المحملة.
* **عرض حجم الملف قبل التحميل** مع تتبع حالة التحميل والتقدم.
* **تنظيم أنظف للموارد** مع واجهات مستقلة للترجمات والتفاسير وبيانات الكلمات.

### 🌍 التفسير والترجمة والدراسة
* **تفاسير عربية متعددة** مدمجة وقابلة للتوسعة عبر الموارد.
* **ترجمات متعددة اللغات** مع دعم تفعيل أكثر من ترجمة في نفس الوقت.
* **معلومات لغوية للكلمة** تشمل الإعراب والصرف والقراءات ومصادر الكلمات.
* **شاشة تفسير مستقلة** لقراءة التفسير والوصول إلى إدارة الموارد مباشرة.

### 🕌 أدوات المسلم اليومية
* **مواقيت صلاة دقيقة** مع إعدادات مرتبطة بالموقع وطرق الحساب.
* **اتجاه القبلة** عبر شاشة مستقلة مخصصة.
* **أذكار المسلم** بفئات متعددة والتنقل من الفئة إلى التفاصيل.
* **الختمة الذكية** لمتابعة الورد والخطط القرآنية.

### 🔔 الإشعارات والتذكيرات
* **تذكير الختمة** اليومي.
* **آية اليوم** بإشعار مستقل.
* **تذكير أذكار الصباح والمساء** مع ضبط الوقت لكل نوع.
* **إشعار تجريبي** لاختبار النظام من شاشة الإعدادات.

### 🧩 التخصيص والإنتاجية
* **ويدجت "آية اليوم" للشاشة الرئيسية** مع تحديث فوري ومعاينة حية.
* **تخصيص كامل للويدجت** يشمل الخط، حجم الخط، الثيم، الألوان، والخلفية المتدرجة، مع إمكانية تثبيت آية معينة.
* **إعدادات رئيسية محسنة** للمظهر العام، إعدادات المصحف، لغة التطبيق، والإشعارات.
* **ثيمات متعددة ومعاينة للسمات** داخل التطبيق.
* **مجموعات ومفضلات وملاحظات** لحفظ التأملات والعلامات المرجعية.
* **مشاركة المحتوى** من عدة شاشات داخل التطبيق، بما في ذلك المشاركة النصية والبصرية.

---

## Performance & Packaging

تمت إضافة مسار واضح لتحسين الأداء وتقليل حجم الحزمة قبل التثبيت، وليس فقط توسيع المزايا:
...
* عند إضافة أصل جديد كبير الحجم، أضفه صراحة في `pubspec.yaml` ولا تعد إلى تضمين مجلدات كاملة دون حاجة.
* أي مورد يمكن تحميله أو تهيئته lazy بعد الإقلاع يفضل ألا يحجب `main.dart` قبل أول frame.
* في `qcf_quran_with_update` يفضل الحفاظ على مسار التحميل الديناميكي للخطوط بدل إعادة شحن جميع خطوط الصفحات داخل الباندل.
...
| **home_widget + workmanager** | تشغيل وتحديث ويدجت آية اليوم على الشاشة الرئيسية بشكل دوري أو فوري. |
| **awesome_notifications** | نظام الإشعارات والتنبيهات للختمة وآية اليوم والأذكار. |
| **share_plus** | مشاركة الآيات والنصوص والمحتوى خارج التطبيق. |
| **qcf_quran_with_update** | النسخة المخصصة من مكتبة عرض المصحف QCF مع تحسينات التصميم والاستجابة. |
| **flutter_animate** | المحرك المسؤول عن حيوية الحركة وانتقالات الواجهة السلسة. |

### 🧩 إعادة الهندسة العميقة (Deep Architecture Restructuring)
تم تفتيت شاشة المصحف العملاقة `mushaf_screen.dart` (التي تجاوزت 7600 سطر) إلى مكونات مستقلة بهدف تسهيل العمل على المبرمجين الآخرين:
1. **الواجهات في `widgets/`:** تم استخراج (الفهرس، الخيارات السفلية، الختمة، البحث، والتقييم) في مجلد مستقل لمنع التشابه والتداخل (Coupling).
2. **العمليات في `extensions/`:** استخدمنا ميزة `part` وفصلنا وظائف نطق الكلمات الشائكة والمشاركة كصورة لملفات مستقلة.
3. التعديلات اللونية المركزية لدعم الوضع الداكن في النوافذ المنبثقة تم توظيفها لتندمج بكل ذكاء مع الخلفيات.
