...
### 📖 القراءة والمصحف | Mushaf Reading

- **مصحف QCF تفاعلي** بخط عثماني (Uthmanic) وصفحات قريبة من المصحف الورقي + دعم Dark/Light.
- **وضع القراءة آية بآية** + تنقل سريع + شريط تحكم صوتي + تفاعل لكل آية.
- **بحث قرآني سريع** داخل النص + الوصول المباشر للسورة/الآية/الصفحة.
- **فهرس وتنقل ذكي** بين السور والأجزاء والأحزاب والصفحات.

### 🧠 المكتبة التفاعلية للآية | Ayah Library (Word-Level)

- **مكتبة مدمجة داخل المصحف** تعرض الآية الحالية بوضوح مع التنقل.
- **اختيار كلمة من الآية** لعرض بياناتها فقط.
- **تبويبات كلمة بكلمة**: الترجمة، الإعراب، الصرف، القراءات.
- **مشاركة الآية** كنص أو بصيغ مشاركة مرتبطة بالمكتبة.
- **عرض التفاسير المختارة** مع تقليل التكرار بين الموارد المدمجة والمحملة.

### 📚 إدارة الموارد القرآنية | Quran Resources

- **مكتبة موارد موحدة**: ترجمات، تفاسير، كلمة بكلمة، معلومات الكلمات.
- **اختيار أكثر من ترجمة وأكثر من تفسير** في نفس الوقت.
- **حذف مورد واحد أو حذف جماعي** للموارد المحملة.
- **عرض حجم الملف قبل التحميل** + تتبع حالة التحميل والتقدم.
- **واجهات مستقلة أنظف** لإدارة الترجمات/التفاسير/بيانات الكلمات.

### 🌍 التفسير والترجمة والدراسة | Tafsir & Study

- **تفاسير عربية متعددة** مدمجة وقابلة للتوسعة.
- **ترجمات متعددة اللغات** مع تفعيل أكثر من ترجمة في نفس الوقت.
- **معلومات لغوية للكلمة** (إعراب/صرف/قراءات/مصادر الكلمات).
- **شاشة تفسير مستقلة** + دخول مباشر لإدارة الموارد.

### 🕌 أدوات المسلم اليومية | Daily Utilities

- **مواقيت صلاة دقيقة** حسب الموقع وطرق الحساب.
- **اتجاه القبلة** في شاشة مستقلة.
- **أذكار المسلم** بفئات متعددة.
- **الختمة الذكية** لمتابعة الورد والخطط.

### 🔔 الإشعارات والتذكيرات | Notifications

- **تذكير الختمة** اليومي.
- **آية اليوم** بإشعار مستقل.
- **تذكير أذكار الصباح والمساء** مع ضبط الوقت.
- **إشعار تجريبي** لاختبار النظام.

### 🧩 التخصيص والإنتاجية | Personalization

- **ويدجت "Ayah of the Day" للشاشة الرئيسية** + تحديث فوري + Live Preview.
- **تخصيص كامل للويدجت**: الخط، حجم الخط، الثيم، الألوان، خلفية متدرجة، وتثبيت آية معينة.
- **إعدادات رئيسية محسنة**: المظهر العام، إعدادات المصحف، لغة التطبيق، الإشعارات.
- **ثيمات متعددة** + معاينة للسمات.
