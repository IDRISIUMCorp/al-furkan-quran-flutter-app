...
class _ImageCustomizationScreenState extends State<ImageCustomizationScreen>
  ...
  List<Widget> _buildBackgroundTabContent(bool isDark) {
    return [
      _buildSectionCard(
        isDark: isDark,
        title: 'نوع الخلفية',
  ...
  List<Widget> _buildLayoutTabContent(bool isDark) {
    return [
      _buildSectionCard(
        isDark: isDark,
  ...
  List<Widget> _buildTextTabContent(bool isDark) {
    return [
      _buildSectionCard(
        isDark: isDark,
        title: 'نوع الخط',
  ...
  List<Widget> _buildElementsTabContent(bool isDark) {
    return [
      _buildSectionCard(
        isDark: isDark,
        title: 'البادج',
  ...
  List<Widget> _buildDecorationsTabContent(bool isDark) {
    return [
      _buildSectionCard(
        isDark: isDark,
        title: 'لون الزخرفة',
  ...
  List<Widget> _buildSizeTabContent(bool isDark) {
    return [
      _buildSectionCard(
        isDark: isDark,
        title: 'حجم الصورة',
